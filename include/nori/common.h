...
#endif
/*
Strong symbols are not allowed to be defined multiple times;
Strong symbols and weak symbols exist at the same time, choose the strong symbol;
There are multiple weak symbols at the same time, choose the one that occupies the largest space;
...
/// Ignore the case of characters and add to vector
extern void stringIgnoreCase(std::string str, size_t depth, std::vector<std::string> &strList);
