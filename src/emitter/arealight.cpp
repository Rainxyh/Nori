...
/*---------------------------------------------------------------------------------------------------------------------------------------------*/
    ...
    virtual float pdf(const EmitterQueryRecord& lRec) const {
        ...
        float pW = lRec.dist * lRec.dist / (cosTheta * m_mesh->surfaceArea()); // m_mesh->pdf() = 1 / surfaceArea()
...
/*---------------------------------------------------------------------------------------------------------------------------------------------*/
    virtual Color3f sample(EmitterQueryRecord & lRec, Sampler* sampler) const {
		...
		return eval(lRec) / lRec.pdf; // Sampling light sources does not require supplemental costheta
    }
/*---------------------------------------------------------------------------------------------------------------------------------------------*/
